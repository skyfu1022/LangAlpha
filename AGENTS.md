...
| Directory | Purpose |
|---|---|
| `src/server/` | FastAPI app, routers (`app/`), handlers, models, services. Has its own [AGENTS.md](src/server/AGENTS.md) with detailed SSE event types and endpoint docs. |
