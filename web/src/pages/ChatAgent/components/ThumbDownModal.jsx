 ...
 * @param {Function} onSubmit - (issueCategories, comment, consentHumanReview) => void
 * @param {Function} onCancel - Close without submitting
 */
function ThumbDownModal({ isOpen, onSubmit, onCancel, onReportWithAgent }) {
